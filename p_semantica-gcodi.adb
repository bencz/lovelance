with p_semantica.gcodi.gcodi3a;
use  p_semantica.gcodi.gcodi3a;
...
package body p_semantica.gcodi is
    ...
    procedure conclou_gcodi is
        ...
        ocup_v:despl;
    begin
        -- Calculam el despla鏰ment de les variables
   ...
   begin
      ...
      ef := nova_etiq;
      empilar(p_etiq, ef);
      -- Avaluaci贸 de l'expressi贸
      gen_ins_if_eq(e.exp_res, nfals, ef);
      -- Creaci贸 de etiquetes inici de condici贸 certa
      gen_ins_etiq(ec);
    end gc_p_sent_if;
